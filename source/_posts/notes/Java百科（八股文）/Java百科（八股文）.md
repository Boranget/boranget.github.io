...
然而，如果Java八股文褪去其”应试“的这层外衣，其本质上是一本很不错的Java百科。并且在开发者们源源不断的的补充下，知识愈发全面。在Java开发过程中如有突然想了解某一部分机制的原理时，翻阅所谓的”Java八股文“，得到答案，豁然开朗。因此比起所谓的”Java八股文“，我更喜欢称呼其为”Java百科“。
...
- synchronized在发生异常时会自动释放锁，lock不会，所以建议在finally块中释放锁
